...
public class BasicModelBasedGenerationExample {
  ...
  public void print() {
    // The model "_???" will tell Datafaker to print an underscore and three random lowercase
    // letters : the '?' is replaced by a random letter
    out.println(
        "Print the digits from 0 to 9, followed by an underscore and three random lowercase letters :");
    ...
    // The model "_???" will tell Datafaker to print an underscore and three random uppercase
    // letters : the '?' is replaced by a random letter
    // The second boolean parameter tells the method to make the letter uppercase
    out.println(
        "Print the digits from 0 to 9, followed by an underscore and three random uppercase letters :");
    ...
    // The model "_###" will tell Datafaker to print an underscore and three random digits : the '#'
    // is replaced by a random digit
    out.println(
        "Print the digits from 0 to 9, followed by an underscore and three random digits :");
    ...
    out.println(
        faker.letterify(
            "Within letterify the question mark ? is a special character but the hash # is not"));
    out.println(
        faker.numerify(
            "Within numerify the hash symbol # is a special character but the question mark ? is not"));
    ...
    out.println(
        "Print the digits from 0 to 9, followed by an underscore, three random lowercase letters, another underscore and three random digits :");
    IntStream.range(0, 10).forEach(i -> out.println(faker.bothify(i + "_???_###")));
    out.println();
    out.println(
        "Print the digits from 0 to 9, followed by an underscore, three random uppercase letters, another underscore and three random digits :");
    ...
    out.println(
        "Print the digits from 0 to 9, followed by an underscore, three random lowercase letters, an underscore, three random uppercase letters, an underscore and three random digits");
    IntStream.range(0, 10).forEach(i -> out.println(faker.examplify(i + "_ABC_abc_123")));
    out.println();
    out.println(
        "The non-alphanumeric symbol are not replaced in examplify ; an example with the model '0aA_?#!:;,*$'");
